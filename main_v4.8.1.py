...
def mode_img_binary(thresholds):
...
def mod_button_4():
    ...
    if button_4.value() == 1:
        ...
        if end_time - start_time > 0 and end_time - start_time < 1.1:
            mode_img_binary(thresholds)
            img = sensor.snapshot()
            print('mode_img_binary')


        elif end_time - start_time >= 3.1 and end_time - start_time < 5.1:
            Setting_Gain()
            img = sensor.snapshot()
            print('Setting_Gain')
