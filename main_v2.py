...
def Set_Gain(img, thresholds, gain, min_area_threshold, max_blob_area_limit,
    ...
    if button.value() == 0:
        ...
        while button.value() == 0:
            ...
            if time.time() - start_time >= 3:
                ...
                while (True):
                    img_detection, gain, blob = Set_Gain(frame, thresholds, gain,
...
while (True):
    ...
    # Обноружение наибольшего белого объекта
    Detecting_Object(img, thresholds, max_blob_area_limit,
